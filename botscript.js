...
cb-btn=document.createElement("button");
cb-btn.class = 'btn btn-default input-group';
cb-btn.onclick = "execmsg();";
cb-btn.value = "Executor";
document.head.appendChild(cb-btn);
